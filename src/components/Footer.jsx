...
<meta name="viewport" content="width=device-width, initial-scale=1.0"/>
	<section id="footer">
		...
		<div className="container-fluid pt-4 fr ">
			...
			<div className='gridf'>
				...
				<div className="col-md-4 fet">
					<h5>FEATURES</h5>
					<ul className="list-unstyled quick-links">
						<li><a href=""><i className="fa fa-angle-double-right"></i>Start react courses</a></li>
				...
				<div className=" col-md-4 con">
					<h5>CONTACT US</h5>
					<ul className="list-unstyled quick-links">
						<li><a href=""><i className="fa fa-angle-double-right"></i>Punjab</a></li>
