...
function Home() {
  ...
  <div className="container-fluid col-md ">
    <div className="d-flex h-100 text-center align-items-center">
      <div className="w-100 tt text-white">
      ...
      <button className="btn bvt2 btn-outline-dark " type="submit" value="Submit">Contact Us</button>
            ...
            <div className=' sp align-items-center'>
                <div className="container-fluid flow pt-3 d-md-block">
                    <div className="row">
                        <div className='col-10 mx-auto'>
                            <div className="row">
                                ...
                                <div className="col-sm-6 col-sm-6 pt-5 pt-lg-0 order-2 order-lg-1 ">
                                    <div className='brand'>
